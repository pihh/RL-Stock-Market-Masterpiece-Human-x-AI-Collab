...
def generate_universe_easiness_report(
    ...
    metrics=("rolling_sharpe", 
             "rolling_r2",
             "rolling_info_ratio", "rolling_autocorr","rolling_sortino","rolling_max_drawdown","rolling_calmar","rolling_hurst","rolling_apen","rolling_variance_ratio",
             #"rolling_predictive_r2",
             #"rolling_hmm_loglik",
             "rolling_volatility_regimes","rolling_avg_dollar_volume","rolling_spread_proxy"),
    target="return_1d",
